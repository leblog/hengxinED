...
public class WxCallback {
    ...
    */
    ...
    @GetMapping("/commitPushDetail/{tasteId}")
    public String commitPushDetail(String tasteId){
    ...
    @ResponseBody
    public AjaxResult msg(@RequestBody String res){
        JSONObject json = JSONUtil.parseFromXml(res);
        HashMap<String,String> map = new HashMap<>();
        JSONObject obj = JSONUtil.parseObj(json.get("ApprovalInfo"));
        JSONUtil.parseObj(obj.get("SpStatus"));
        log.info("内容:{}",JSONUtil.parseObj(obj.get("SpStatus")));
        log.info("数据内容接收转json={}",json);
        // 校验状态变化,比对如果不通过直接,
