...
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '口味申请单明细表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of hx_taste_detail
-- ----------------------------
INSERT INTO `hx_taste_detail` VALUES (27, '测试1', '1531196444072964097', '测试1', '0', '测试1', '测试1', '测试1', '测试1', '测试1', '测试1', '0', '测试1', '测试内容', NULL, NULL, NULL, NULL, '');
INSERT INTO `hx_taste_detail` VALUES (28, '测试2', '1531196444072964097', '测试1', '1', '测试2', '测试2', '测试2', '测试2', '测试2', '测试2', '0', '测试2', '测试212232341234', NULL, NULL, NULL, NULL, '');
